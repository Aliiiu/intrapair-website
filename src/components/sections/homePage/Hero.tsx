    ...
    <section className="container m-auto   px-[30px] relative">
      ...
      <div className=" flex items-center  justify-center sm:py-[120px] py-9 w-[100%] sm:w-[80%] m-auto">
        <div className="flex flex-col gap-6 justify-center  text-center">
          ...
          <button className="rounded-[41px]  text-base w-[202px] bg-dark-blue text-white py-[15px] m-auto hover:bg-white hover:text-dark-blue border-dark-blue border duration-300 ease-in-out">
            Let&apos;s Talk
          </button>
        </div>
      </div>
