    ...
    <div className="container m-auto px-4 xl:px-[114px] w-full">
      ...
      <div className="flex">
        <div className="overflow-x-scroll scrollbar-hide py-8 flex  gap-[46px] justify-between w-full">
          <div className="relative flex flex-col border-2  border-solid border-dark-blue p-[20px] xl:p-[60px] gap-[74px] min-w-[326px] w-[526px] testimony-container">
            ...
            <p className="text-white text-xl z-30">
